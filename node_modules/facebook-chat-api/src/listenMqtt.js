  ...
  return function (callback) {
    ...
    defaultFuncs
      ...
      .then((resData) => {
        ...
        if (resData && resData.length > 0 && resData[resData.length - 1].successful_results === 0) {
          throw { error: "getSeqId: there was no successful_results", res: resData };
        }

        if (resData && resData.length > 0 && resData[0].o0.data.viewer.message_threads.sync_sequence_id) {
